function v1() {
  location.href = "portfolio-v1/index.html";
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector("#form1").onkeyup = () => {
    if (
      document.querySelector("#exampleFormControlInput1").value.length > 0 ||
      document.querySelector("#exampleFormControlTextarea1").value.length > 0
    ) {
  ...
  document.querySelector("#form1").onsubmit = function () {
    ...
    const suggestionOn = document.querySelector(
