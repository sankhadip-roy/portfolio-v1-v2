...
function feedBack() {
  ...
  if (a >= 7 && a <= 10) {
    ...
    let lowFeedback =
      a < 5 ? "Sorry for your dissapointment !" : "Invalid feedback !";
...
function count() {
  ...
  document.querySelector("#hello").innerHTML = `
                <p>I'm <b>Sankhadip roy</b>, majoring in CSE. This is my
                    ...
                    give me some suggesion. <caption><u><big><strong>Watchtime: ${Math.trunc(
                      counter / 60
                    )}:${counter % 60} min</strong></big></u></caption></p>`;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  $("#showAlert").click(function () {
    Swal.fire("If mobile device: use a Desktop (This website isn't optimized)");
    element1.remove();
  });
});
